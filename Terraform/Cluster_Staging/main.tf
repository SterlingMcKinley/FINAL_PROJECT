...
resource "aws_ecs_cluster" "aws-ecs-cluster" {
  name = "final-project-cluster-staging"
  tags = {
    Name = "final-project-ecs-staging"
  }
  setting {
...
resource "aws_cloudwatch_log_group" "log-group" {
  name = "/ecs/final-project-logs-staging"

  tags = {
    Application = "final-project-staging"
  }
}
...
resource "aws_ecs_task_definition" "aws-ecs-task" {
  family = "final-project-task-staging"
...
resource "aws_ecs_service" "aws-ecs-service" {
  name                 = "final-project-ecs-service-staging"
